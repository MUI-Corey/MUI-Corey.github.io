...
feature_row:
  - image_path: /assets/images/2d-game-3.png
    alt: "2D Game"
    title: "2D Game"
    excerpt: "This was the first **2D** game I created. It features a parralax background, a hunger mechanic and quick movement. © [2026] [Coraero]"
  ...
  - image_path: /assets/images/3d-game-3.png
    alt: "3D game"
    title: "3D Game"
    excerpt: "This was the first **3D** game I created. It features a coin collecting mechanic, momentum-focused running and jumping for platforming and a dim-lit foggy environment. © [2026] [Coraero]"
...
<div class="mock-layout">
  ...
  <div class="center">
    ...
    <div class="video-wrapper">
      {% include video id="GqMe6E88c10" provider="youtube" %}
    </div>
